...
set_property SLEW SLOW [get_ports {leds_tri_o[3]}]
set_property SLEW SLOW [get_ports {leds_tri_o[2]}]
set_property SLEW SLOW [get_ports {leds_tri_o[1]}]
set_property SLEW SLOW [get_ports {leds_tri_o[0]}]
set_property DRIVE 12 [get_ports {leds_tri_o[3]}]
set_property DRIVE 12 [get_ports {leds_tri_o[2]}]
set_property DRIVE 12 [get_ports {leds_tri_o[1]}]
set_property DRIVE 12 [get_ports {leds_tri_o[0]}]
